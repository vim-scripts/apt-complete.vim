...
VIMLIB = .
VIMMETA = META
TO_INST_VIMS = plugin/aptcomplete.vim
VIMS_TO_RUNT = plugin/aptcomplete.vim \
	$(VIM_BASEDIR)/plugin/aptcomplete.vim
...
link : 
		$(NOECHO) $(LN_S) $(PWD)/plugin/aptcomplete.vim $(VIM_BASEDIR)/plugin/aptcomplete.vim

link-force : 
		$(NOECHO) $(LN_SF) $(PWD)/plugin/aptcomplete.vim $(VIM_BASEDIR)/plugin/aptcomplete.vim

unlink : 
		$(NOECHO) $(RM) $(VIM_BASEDIR)/plugin/aptcomplete.vim
